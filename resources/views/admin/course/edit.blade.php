...
@section('header')
    <header class="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-xl font-bold text-slate-900">Edit Course</h1>
        </div>
...
@section('content')
    ...
    @push('script')
        <script>
            ...
            const sub_names = @json($sub_names);
            const subjects = new Set(sub_names);
            ...
            function renderSubjects() {
                if (subjects.size === 0) {
                    subjectsList.innerHTML = '<p class="text-xs text-slate-400 italic p-2">No subjects added yet...</p>';
                    return;
                }
